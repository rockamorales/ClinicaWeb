...
@ManagedBean
@ViewScoped
public class DonacionesEmitidosDataProvider implements ClinicaDataProvider<TblComprobanteDonacion, Integer> {
    @EJB
    private TblComprobanteDonacionFacadeLocal facade;

    @ManagedProperty(value="#{donacionesEmitidosSearchCriteria}")
