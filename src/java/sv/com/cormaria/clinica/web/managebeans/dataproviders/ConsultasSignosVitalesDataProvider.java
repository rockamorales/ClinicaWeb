...
@ManagedBean
@ViewScoped
public class ConsultasSignosVitalesDataProvider implements ClinicaDataProvider<TblConsultas, Integer> {
    @EJB
    private TblConsultasFacadeLocal facade;

    @ManagedProperty(value="#{consultasSigVitalesSearchCriteria}")
