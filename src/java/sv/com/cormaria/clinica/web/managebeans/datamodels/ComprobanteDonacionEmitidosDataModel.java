...
@ManagedBean
@ViewScoped
public class ComprobanteDonacionEmitidosDataModel extends ClinicaDataModel<TblComprobanteDonacion, Integer> {

    @ManagedProperty(value="#{comprobanteDonacionEmitidosDataProvider}")
