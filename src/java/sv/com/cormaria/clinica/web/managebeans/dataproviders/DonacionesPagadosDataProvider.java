...
@ManagedBean
@ViewScoped
public class DonacionesPagadosDataProvider implements ClinicaDataProvider<TblComprobanteDonacion, Integer> {
    @EJB
    private TblComprobanteDonacionFacadeLocal facade;

    @ManagedProperty(value="#{donacionesPagadosSearchCriteria}")
