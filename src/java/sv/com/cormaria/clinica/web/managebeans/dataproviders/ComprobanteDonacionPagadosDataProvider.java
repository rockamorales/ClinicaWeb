...
@ManagedBean
@ViewScoped
public class ComprobanteDonacionPagadosDataProvider implements ClinicaDataProvider<TblComprobanteDonacion, Integer> {
    @EJB
    private TblComprobanteDonacionFacadeLocal facade;

    @ManagedProperty(value="#{comprobanteDonacionPagadosSearchCriteria}")
