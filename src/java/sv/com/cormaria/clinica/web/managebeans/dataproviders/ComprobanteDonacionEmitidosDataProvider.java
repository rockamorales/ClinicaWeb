...
@ManagedBean
@ViewScoped
public class ComprobanteDonacionEmitidosDataProvider implements ClinicaDataProvider<TblComprobanteDonacion, Integer> {
    @EJB
    private TblComprobanteDonacionFacadeLocal facade;

    @ManagedProperty(value="#{comprobanteDonacionEmitidosSearchCriteria}")
