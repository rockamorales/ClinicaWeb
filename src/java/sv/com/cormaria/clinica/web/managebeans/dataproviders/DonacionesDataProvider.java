...
@ManagedBean
@ViewScoped
public class DonacionesDataProvider implements ClinicaDataProvider<TblComprobanteDonacion, Integer> {
    @EJB
    private TblComprobanteDonacionFacadeLocal facade;

    public DonacionesDataProvider() {
    }

    @ManagedProperty(value="#{donacionesSearchCriteria}")
